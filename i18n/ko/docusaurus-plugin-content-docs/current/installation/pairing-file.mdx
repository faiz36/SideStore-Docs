---
title: 페어링 파일
description: 페어링 파일은 SideStore가 정상 작동하게 하는 필수적인 요소입니다.
sidebar_position: 2
---

JitterbugPair (Jitterbug 앱이 *아닙니다*)를 사용해서 SideStore와 같은 프로그램들이 기기와 통신 할 수 있도록 하는 페어링 파일을 생성합니다. 이 파일은 SideStore을 사용하려면 필수적이고 없다면 정상 작동하지 않습니다.


[Windows (64비트)](https://github.com/osy/Jitterbug/releases/download/v1.3.1/jitterbugpair-win64.zip), [macOS](https://github.com/SideStore/SideStore-Docs/releases/download/need-a-place-to-put-jittterbug/jitterbugpair), 또는 [Linux](https://github.com/osy/Jitterbug/releases/download/v1.3.1/jitterbugpair-linux.zip)용 JitterbugPair를 다운로드합니다.
